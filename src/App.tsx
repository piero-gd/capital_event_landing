...
const App: React.FC = () => {
  return (
    <div className="relative min-h-screen w-full bg-black text-white flex flex-col items-center overflow-hidden">
      ...
      {/* Fondos superiores e inferiores para móvil */}
      <div className="fixed inset-x-0 top-0 h-1/4 bg-[url('/img/bg_sup_m.png')] bg-cover bg-no-repeat md:hidden"></div>
      <div className="fixed inset-x-0 bottom-0 h-1/3 bg-[url('/img/bg_inf_m.png')] bg-cover bg-no-repeat bg-bottom md:hidden"></div>
